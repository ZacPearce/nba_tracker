...
urlpatterns = [
        ...
        path('teams/delete/<int:team_id>/', 
             views.delete_team, name='delete-team'),
        path('players/', views.player_list, name='player-list'),
        path('players/add/', views.create_player, name='add-player'),
        path('players/delete/<int:player_id>/', 
             views.delete_player, name='delete-player'),
        path('watchlist/', views.watchlist, name='watchlist'),
        path('add-to-watchlist/<int:player_id>/', 
             views.add_to_watchlist, name='add-to-watchlist'),
        ...
        path('game-logs/delete/<int:log_id>/', 
             views.delete_game_log, name='delete-game-log'),
]
